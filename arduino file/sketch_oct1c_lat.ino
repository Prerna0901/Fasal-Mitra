...
char auth[] = "xxxxxxxxxxxxxxxxxxxxxxxxxxx";   //Enter your Auth token
char ssid[] = "Aryan's";    //Enter your WIFI name
char pass[] = "41r9Y08$";  //Enter your WIFI password
...
//   if (sensorState == HIGH && prevState == 0) {
//     waterOn();
//     prevState = 1;
//     delay(1000);
//   } else if (sensorState == HIGH && prevState == 1) {
//     delay(1000);
//   } else {
//     waterOff();
//     prevState = 0;
